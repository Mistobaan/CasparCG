...
class WIDGETS_EXPORT RundownWidget : public QWidget, Ui::RundownWidget
{
    ...
    private:
        ...
        void parseGroup(const QString& name, const QString& deviceName, const QString& type, const boost::property_tree::wptree& pt);
        void parseItem(const QString& name, const QString& deviceName, const QString& type, const boost::property_tree::wptree& pt, QTreeWidgetItem* parent);
