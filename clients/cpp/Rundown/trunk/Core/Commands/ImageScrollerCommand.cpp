...
void ImageScrollerCommand::loadProperties(const boost::property_tree::wptree& pt)
{
...
void ImageScrollerCommand::saveProperties(const boost::property_tree::wptree& pt)
{
}
