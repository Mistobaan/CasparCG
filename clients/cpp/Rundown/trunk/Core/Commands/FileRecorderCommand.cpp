...
void FileRecorderCommand::loadProperties(const boost::property_tree::wptree& pt)
{
...
void FileRecorderCommand::saveProperties(const boost::property_tree::wptree& pt)
{
}
