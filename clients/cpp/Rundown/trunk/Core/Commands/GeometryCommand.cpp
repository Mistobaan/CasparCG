...
GeometryCommand::GeometryCommand(QObject* parent)
    : QObject(parent),
      ...
      allowGpi(Output::DEFAULT_ALLOW_GPI), positionX(Mixer::DEFAULT_GEOMETRY_POSITION_X),
      positionY(Mixer::DEFAULT_GEOMETRY_POSITION_Y), scaleX(Mixer::DEFAULT_GEOMETRY_SCALE_X),
      scaleY(Mixer::DEFAULT_GEOMETRY_SCALE_Y), duration(Mixer::DEFAULT_DURATION), tween(Mixer::DEFAULT_TWEEN),
...
void GeometryCommand::loadProperties(const boost::property_tree::wptree& pt)
{
...
void GeometryCommand::saveProperties(const boost::property_tree::wptree& pt)
{
}
