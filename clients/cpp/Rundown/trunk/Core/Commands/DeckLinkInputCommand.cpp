...
void DeckLinkInputCommand::loadProperties(const boost::property_tree::wptree& pt)
{
...
void DeckLinkInputCommand::saveProperties(const boost::property_tree::wptree& pt)
{
}
